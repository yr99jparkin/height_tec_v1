...
import AdminDeviceManagementPage from "@/pages/admin-device-management-page";
...
function Router() {
  return (
    <Switch>
      ...
      <AdminProtectedRoute path="/admin/device-management" component={AdminDeviceManagementPage} />
