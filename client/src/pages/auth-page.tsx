...
export default function AuthPage() {
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-primary flex items-center justify-center gap-2">
              <img src="/height-tec-logo.png" alt="Height-tec logo" className="h-14" />
            </CardTitle>
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center">
              <h1 className="text-3xl font-bold text-primary font-heading flex items-center justify-center gap-2">
                <img src="/height-tec-logo.png" alt="Height-tec logo" className="h-16" />
              </h1>
      ...
      <div className="w-full md:w-1/2 bg-primary p-8 flex items-center justify-center text-primary-foreground">
